...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    reviewInstruction: 'After reviewing, click Save Question to add it to Saved Questions.',
    editMode: 'Edit Mode',
    ...
    failedGenerate: 'Failed to generate question.',
    nonMedicalError: 'Only medical content is supported. Please provide medical text.',
    generateTab: 'Generate Question',
    savedTab: 'Saved Questions',
    footerText: '\u00A9 2024 Question Drafter AI. For educational and research purposes only.',
    saveSuccess: 'Question saved.',
    saveSuccessMultiple: '{count} questions saved.',
    failedSave: 'Failed to save questions.',
    viewSaved: 'View Saved Questions',
    ...
    tourGenerateButton: 'Click this button to generate the questions.',
  ...
  'zh-Hant': {
    ...
    failedGenerate: '\u7121\u6CD5\u751F\u6210\u984C\u76EE\u3002',
    nonMedicalError: '\u6B64\u61C9\u7528\u50C5\u652F\u63F4\u91AB\u7642\u76F8\u95DC\u7684\u5167\u5BB9\uFF0C\u8ACB\u63D0\u4F9B\u91AB\u5B78\u6587\u672C\u3002',
    generateTab: '\u751F\u6210\u984C\u76EE',
    savedTab: '\u5DF2\u5132\u5B58\u984C\u76EE',
    footerText: '\u00A9 2024 Question Drafter AI\u3002\u50C5\u4F9B\u6559\u80B2\u8207\u7814\u7A76\u7528\u9014\u3002',
    saveSuccess: '\u984C\u76EE\u5DF2\u5132\u5B58\u3002',
    saveSuccessMultiple: '\u5DF2\u5132\u5B58 {count} \u500B\u984C\u76EE',
    failedSave: '\u7121\u6CD5\u5132\u5B58\u984C\u76EE',
    viewSaved: '\u6AA2\u8996\u5DF2\u5132\u5B58\u984C\u76EE',
    backToInput: '\u8FD4\u56DE\u8F38\u5165\u9801\u9762',
    saveAll: '\u5168\u90E8\u4FDD\u5B58',
    ...
    progressStep3: '\u6B65\u9A5F 3\uFF1A\u67E5\u770B\u5DF2\u5132\u5B58\u984C\u76EE',
    chooseQuestionCount: '\u9078\u64C7\u8981\u751F\u6210\u7684\u984C\u6578',
    numberOfQuestions: '\u984C\u6578',
    questionType: '\u984C\u578B',
    questionCountDisplay: '\u7B2C {current}/{total} \u984C',
    selectAll: '\u5168\u9078',
    generateYourFirstQuestion: '\u751F\u6210\u7B2C\u4E00\u984C',
    welcome: '\u6B61\u8FCE\u4F7F\u7528 Question Drafter AI',
