...
describe('generateQuestionFromText', () => {
  it('returns a valid question object for MultipleChoice type', async () => {
    const question = await generateQuestionFromText(sampleText, QuestionType.MultipleChoice);
    ...
    expect(question.citation.source).toBe('PubMed');
